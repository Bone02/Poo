...
import Cap4.Ejercicio10.Equipo;
...
public class EquipoFutbol {
    ...
    public EquipoFutbol(String nombre, String ciudad, Tecnico tecnico, Portero portero, Defensa[] defensa, Mediocampo[] mediocampo, Delantero[] delantero) {
        this(nombre,ciudad);
